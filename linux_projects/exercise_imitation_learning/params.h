...
//#define WORLD_FILENAME "world4.png"
...
#define INTERACTIVE_LEARNING 1
#define RANDOM_START_POS 1
#define MAX_AVG_DISTANCE_BEFORE_GOING_BACK_TO_DEMO_MODE 100
#define USE_K_NEIGHBORS 3
