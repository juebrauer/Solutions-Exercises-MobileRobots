/// Exercise: Robot localization WITH a map
///
/// Task:
/// -----
/// The goal of this exercise is to let students think
/// about own ideas to localize a robot that wakes up
/// (is switched on) and does not have a localization
/// sensor.
///
...
/// In order to be accelerate the search we do not check
